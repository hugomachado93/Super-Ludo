...
public class Caminho {
	...
	public Caminho(int num) {
		if(num == 1) {
			casas.add(new Casa(50,300,0, false));
			...
			casas.add(new Casa(300, 50, 0, true));
